...
The gateway is also a good sanity check for the rest of the Meridian Commerce. If this service is healthy but downstream traffic is failing, the problem is probably in one of the services it calls rather than in the request entry point itself.
